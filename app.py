...
trial_sample.loc[:,'jitter_producedTime'] =  trial_sample['producedTime'].apply(lambda x:x + random.uniform(-0.5, 0.5))
trial_sample.loc[:,'jitter_reactionTime'] = trial_sample['reactionTime'].apply(lambda x:x + random.uniform(-0.5, 0.5))
trial_sample.loc[:,'jitter_trueTime'] = trial_sample['trueTime'].apply(lambda x:x + random.uniform(-0.5, 0.5))
...
ax = speed_1.plot(y='trueTime',x='jitter_producedTime',kind='scatter',marker='o',ax=ax,label='1x',alpha=0.7)
ax = speed_2.plot(y='trueTime',x='jitter_producedTime',kind='scatter',marker='^',ax=ax,label='0.75x',alpha=0.7)
...
fig ,ax = plt.subplots()
ax = speed_1.plot(y='reactionTime',x='jitter_trueTime',kind='scatter',marker='o',ax=ax,label='1x',alpha=0.7)
ax = speed_2.plot(y='reactionTime',x='jitter_trueTime',kind='scatter',marker='^',ax=ax,label='0.75x',alpha=0.7)
ax.tick_params(axis='x', rotation=45)
ax.tick_params(axis='y', rotation=45)
ax.legend(loc='upper left')
